...
<template>
  ...
  <div class="h-auto" id="contentToPrint">
    <section
    ...
    <section
        ...
        >
          ...
          <li class="me-2" role="presentation">
            <button
                ...
                role="tab" type="button">Por plan de estudio
            </button>
          </li>
        </ul>
      </div>
      <div id="rounded-lg ">
        ...
        <div id="contacts" aria-labelledby="contacts-tab" class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800"
             role="tabpanel">
          <SectionGrap
              :cols="cols"
              :height="'600'"
    ...
    <button @click="generatePdf('contentToPrint')">Generar PDF</button>
  </div>
</template>